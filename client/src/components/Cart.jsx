                    ...
                    <div className="max-w-md flex">
                      {groupId === "" ? (
                        <button
                          ...
                          class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-8"
                        >
                          Create Group Order
                        </button>
                      ) : isOwner === true ? (
                        <div>
                          <div className="flex">
                            <button
                              ...
                              class="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-8"
                            >
                              Invite
                            </button>
                            <button
                              onClick={handleDeleteGroupOrder}
                              class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mr-8"
                            >
                              Delete This Group
                            </button>
                          </div>
